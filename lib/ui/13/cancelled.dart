...
class Cancelled extends StatefulWidget {
  const Cancelled({super.key, required this.userId});
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('status', isEqualTo: 'cancelled') // Lọc theo status = 'success'
            .snapshots(),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(child: Text("Bạn không có đơn hàng bị hủy."));
          }
